...
a random page of the Frinkiac JSON API to pull the frame and three lines of quote content, which are
covnerted to the "Simpson's font" and generated onto the image itself.

------INSTALL-------


This repository only contains source code and the bot is not currently hosted online anywhere. In 
order to install and use it on your own servers, you must either host it somewhere, or run the code
locally whenever you plan to use it. From there, standard Discord bot procedures follow.
